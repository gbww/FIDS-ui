...
angular.module('com.app').controller('CompanyCreateCtrl', function ($uibModalInstance, ReviewService, toastr, varietyList, scaleList) {
	var vm = this;
  ...
  vm.ok = function () {
  	ReviewService.createCompany(vm.company).then(function (response) {
